...
if (!window['google']['loader']) {
    ...
    (function () {
        ...
        n(google, function (a, b, c) {
            ...
            var f = a,
                c = c || {};
            if (a instanceof Array || a && "object" == typeof a && "function" == typeof a[C] && "function" == typeof a.reverse) for (var i = 0; i < a[x]; i++) e(a[i]);
            else e(a);
            if (a = N[":" + f]) {
                c && !c.language && c.locale && (c.language = c.locale);
                c && "string" == typeof c.callback && (i = c.callback, i.match(/^[[\]A-Za-z0-9._]+$/) && (i = l.eval(i), c.callback = i));
        ...
        n(V[y], function (a, b) {
            ...
            if (c[x]) {
                ...
                if (!b && O[":" + this.b] != h && O[":" + this.b].versions[":" + a] != h && !google[A].AdditionalParams && this.j) {
                    ...
                    for (var S in c.properties) S && ":" == S[r](0) && (google[this.b][S[B](1)] = c.properties[S]);
        ...
        W[y].F = function (a, b, c) {
            ...
            if (c != h) for (var f in c) a.params[f] ? e += "&" + Y(a.params[f], c[f]) : "other_params" == f ? e += "&" + c[f] : "base_domain" == f && (b = "http://" + c[f] + a.uri[B](a.uri[t]("/", 7)));
        ...
        W[y].w = function (a) {
            if (this.p) for (var b = 0; b < this.p[x]; ++b) {
                var c = this.p[b];
        ...
        var da = j,
            ...
            ca = function (a, b, c) {
                ...
                if (c) {
                    if (!google[A].Secure && (!google[A].Options || google[A].Options.csi === j)) a = a[D]()[q](/[^a-z0-9_.]+/g, "_"), b = b[D]()[q](/[^a-z0-9_.]+/g, "_"), l[z](H($, h, "//gg.google.com/csi?s=uds&v=2&action=" + k(a) + "&it=" + k(b)), 1E4)
                } else Z[p]("r" + Z[x] + "=" + k(a + (b ? "|" + b : ""))), l[z](fa, 5 < Z[x] ? 0 : 15E3)
            },
            fa = function () {
                if (Z[x]) {
                    var a = google[A][u];
    ...
    google.loader.rfm({
        ":search": {
            ...
            "path": "/api/search/1.0/06462c2f0df8b0880b617a0396477b5f/",
            "js": "default+fr.I.js",
            "css": "default+fr.css",
            "properties": {
                ":JSHash": "06462c2f0df8b0880b617a0396477b5f",
                ":NoOldNames": false,
                ":Version": "1.0"
            }
        },
        ":language": {
            ...
            "path": "/api/language/1.0/a0bd458876c67d6b4272493cc004a8ff/",
            "js": "default+fr.I.js",
            "properties": {
                ":JSHash": "a0bd458876c67d6b4272493cc004a8ff",
                ":Version": "1.0"
            }
        },
        ":feeds": {
            ...
            "path": "/api/feeds/1.0/efe8f95c5756111c3e36c06dab50fd12/",
            "js": "default+fr.I.js",
            "css": "default+fr.css",
            "properties": {
                ":JSHash": "efe8f95c5756111c3e36c06dab50fd12",
                ":Version": "1.0"
            }
        },
        ":spreadsheets": {
        ...
        ":annotations": {
            ...
            "path": "/api/annotations/1.0/35a28186b721d9e08b0c0b439b3c55b8/",
            "js": "default+fr.I.js",
            "properties": {
                ":JSHash": "35a28186b721d9e08b0c0b439b3c55b8",
                ":Version": "1.0"
            }
        },
        ":picker": {
